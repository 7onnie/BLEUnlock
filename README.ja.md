...
BLEUnlock は現在、MAC アドレス取得のために短時間接続した後すぐに切断します。RSSI はすべて広告信号から読み取られるため、個別のパッシブモードは不要になりました。
...
*無信号タイムアウト*を大きくしてください。それでも解決しない場合、BLEUnlock は MAC アドレス取得のため短時間接続し直ちに切断します。RSSI は広告信号から読み取られます。
...
それでも問題が繰り返し起こる場合、*無信号タイムアウト*を大きくしてください。
